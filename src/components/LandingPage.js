    ...
    <div>
      ...
      <div className='features-block-2'>
        <div className='feature'>
          ...
          <p>
            Create, edit and delete reports without smudging ink with crossed
            out info
          </p>
        </div>
        <div className='feature'>
          ...
          <p>
            Created to help ease the stress of keeping track of your "brains" so
      ...
      <>
        <Swiper navigation={true} className='mySwiper'>
          <SwiperSlide><div className='feature'>
          <h3>Keep all your patient reports in one place</h3>
          <p>Easily access all of your reports from the home page</p>
        </div></SwiperSlide>
          <SwiperSlide><div className='feature'>
